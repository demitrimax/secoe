...
$(document).ready( function () {
    ...
    <script type="text/javascript">
  	function AplicarFiltro(sel) {
		...
		$('input[name="idactivo"]:checked').each(function() {
						selAct.push(this.value);
					});
		selAct = $('#ms').multipleSelect('getSelects');

		window.location.href = "operatividad_dias.php?programa="+valueA+"&ano="+valueB+"&inter="+selInter+"&esquema="+selEsq+"&activo="+selAct; 
	}
    ...
    <div class="grid_12">
        <h3>Operatividad de equipos</h3>
         <p>  
		  ...
		  <?php /* $contG = 0; ?>
		   <?php do { 	?>
          <input type="checkbox" name="idactivo" value="'<?php echo $row_activos['id_activo'];?>'" id="CheckboxGroup2_<?php echo $contG; ?>"<?php if (in_array("'".$row_activos['id_activo']."'", $colname_activo_array)) {echo "checked";} ?>>
      		<label for="CheckboxGroup2_<?php echo $contG; ?>"><span></span><?php echo $row_activos['ACTIVO'];?></label> |
            <?php
			$contG++;
...
<script>
    $(function() {
        ...
        <?php do { ?>
          <?php 
			$EqDias[] = array($row_Recordset1['Equ_corto'], $row_Recordset1['TEquipo'], $row_Recordset1['ENE'], $row_Recordset1['FEB'], $row_Recordset1['MAR'], $row_Recordset1['ABR'], $row_Recordset1['MAY'], $row_Recordset1['JUN'], $row_Recordset1['JUL'], $row_Recordset1['AGO'], $row_Recordset1['SEP'], $row_Recordset1['OCT'], $row_Recordset1['NOV'], $row_Recordset1['DIC'], $row_Recordset1['PMXCIA'], $row_Recordset1['idEquipo'], $row_Recordset1['Caracteristicas'], $row_Recordset1['PMXCIA2'], $row_Recordset1['tipoequipo']);
			 
			 //MATRIZ ALMACENAR DIAS
			 $EquipDias[] = array('EqCorto'=>$row_Recordset1['Equ_corto'], 'TEquipo'=>$row_Recordset1['TEquipo'], 'ENE'=>$row_Recordset1['ENE'], 'FEB'=>$row_Recordset1['FEB'], 'MAR'=>$row_Recordset1['MAR'], 'ABR'=>$row_Recordset1['ABR'], 'MAY'=>$row_Recordset1['MAY'], 'JUN'=>$row_Recordset1['JUN'], 'JUL'=>$row_Recordset1['JUL'], 'AGO'=>$row_Recordset1['AGO'], 'SEP'=>$row_Recordset1['SEP'], 'OCT'=>$row_Recordset1['OCT'], 'NOV'=>$row_Recordset1['NOV'], 'DIC'=>$row_Recordset1['DIC'], 'PMXCIA'=>$row_Recordset1['PMXCIA'], 'IDEQUIPO'=>$row_Recordset1['idEquipo'], 'CARACTERISTICAS'=>$row_Recordset1['Caracteristicas']);
		 ...
		 for ($i=0; $i<count($EqDias); $i++) {
				...
				$EquipOp[] = array('EqCorto'=>$EquipDias[$i]['EqCorto'], 'TEquipo'=>$EquipDias[$i]['TEquipo'], 'PMXCIA'=>$EquipDias[$i]['PMXCIA'], 'ENE'=>$EquipDias[$i]['ENE']);
		 }
        ...
        window.onload = function() {
         ...
         <h3><p>Por tipo de Equipo</p></h3>
            ...
            <tr>
              ...
              <th width="50" scope="col"><strong>NOV</strong></th>
              <th width="50" scope="col"><strong>DIC</strong></th>
              <th width="50" scope="col"><strong>TOTAL ANUAL</strong></th>
             </tr>
             <tr>
              ...
              <td width="50"><?php echo number_format($AEPMX[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($AECIA[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($MOD[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($EMP[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($TERPMX[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($TERCIA[12],1); ?></td>
            </tr>
            <tr>
              ...
              <td width="50"><?php echo number_format($SS[12],1); ?></td>
            </tr>
            <tr>
              <th width="300" scope="row"> TOTAL </th>
              ...
              <td width="50"><strong><?php echo number_format($MTotal,1); ?></strong></td>
            </tr>
          </table>
    ...
    <p>Mostrar código <input type="button" value="Mostrar" onClick="MostrarOcultar('codigo1', 'mostrar')"> </p>
    	...
    	<div id="codigo1" style="display:none">
            ...
            <p> <?php print_r($TablaOperatividad); ?><br>
            
            <p> <?php print_r($EquipDias); ?> <br>
