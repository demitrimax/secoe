...
//echo "Fecha Inicio: ".$FechaInicio."; Fecha Termino: ".$FechaTermino;
...
<head>
<title>Operatividad de Equipos <?php echo $colname_programa." Año: ".$colname_anopot;?></title>
<meta charset="utf-8">
...
<script type="text/javascript" language="javascript" src="DataTables/extensions/Buttons/js/buttons.print.min.js"></script>
    ...
    <script type="text/javascript" language="javascript" src="DataTables/extensions/jszip.min.js"></script>
	<script type="text/javascript" language="javascript" src="DataTables/extensions/pdfmake.min.js"></script>
	<script type="text/javascript" language="javascript" src="DataTables/extensions/vfs_fonts.js"></script>
...
$(document).ready( function () {
    ...
    <script type="text/javascript">
  	function AplicarFiltro(sel) {
		...
		window.location.href = "operatividad.php?programa="+valueA+"&ano="+valueB+"&inter="+selInter+"&esquema="+selEsq+"&activo="+selAct; 
	}
